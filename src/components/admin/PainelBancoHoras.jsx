...
/**
 * Para um único funcinoário e lista de pontos, calcula o resumo diário.
 * Retorna array de { dataKey, data, minutosTrabalhados, minutosEsperados, diferenca, status }
 */
function calcularResumoDiario(pontos, jornada) {
  ...
  }).sort((a, b) => new Date(b.dataKey) - new Date(a.dataKey));
}
